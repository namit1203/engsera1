          ...
          <div className="row justify-content-center">
            <div className="col-lg-4 col-md-6">
              <div className="single-advisor-box">
                ...
                <div className="advisor-content">
                  <h3>William James</h3>
                  <span className="sub-title">English Language Teacher</span>
                  <p>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-advisor-box">
                ...
                <div className="advisor-content">
                  <h3>Sarah Taylor</h3>
                  <span className="sub-title">Spanish Language Teacher</span>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    do eiusmod tempor incididunt ut labore et dol aliqua.
                  </p>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-advisor-box">
                ...
                <div className="advisor-content">
                  <h3>James Robert</h3>
                  <span className="sub-title">Japanese Language Teacher</span>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    do eiusmod tempor incididunt ut labore et dol aliqua.
                  </p>
